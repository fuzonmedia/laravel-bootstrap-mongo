...
class OrdersController extends Controller
{
    ...
    public function serverside()
    {
      ...
      ->addColumn('action', function ($orders) {
              return '<a href="/orders/edit/'.$orders->_id.'" class="btn btn-xs btn-primary"><i class="glyphicon glyphicon-edit"></i> Edit</a>&nbsp;&nbsp;<a href="/orders/delete/'.$orders->orderID.'" class="btn btn-xs btn-primary" onclick="return confirm(\'Are you sure?\')"><i class="glyphicon glyphicon-delete"></i> Delete</a>';
          })
      ->removeColumn('_id')
      ->make();
    }
    ...
    //return redirect()->back();
    return Redirect::to('orders/edit/'.$order->_id);
